...
//elseif(is_page('events')) {wp_redirect($blog_base_url . '/events/markets/'); exit;}
...
<li<?php if(is_page('press') || $post->post_parent == 269) {echo ' class="current_page_item"';} ?>><a href="<?php bloginfo('url'); ?>/press/">Press</a></li>
